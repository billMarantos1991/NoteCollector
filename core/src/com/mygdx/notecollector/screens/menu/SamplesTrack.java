...
public class SamplesTrack implements Screen {
    ...
    public SamplesTrack(NoteCollector noteCollector,int speed,long delay) {
                    ...
                    Timer.schedule(new Timer.Task() {
                        ...
                        public void run() {
                            if (text.equals("Back"))
                                ...
                                noteCollector.setScreen(new Browse(noteCollector, speed, delay));
    ...
    private void ListStyle(){
        ...
        fontList = assetsManager.createBimapFont(24);
